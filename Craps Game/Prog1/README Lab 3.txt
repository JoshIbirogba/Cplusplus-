...
//Program 1
***Variables***
Global variable maxWager is declared as an integer and stored in a memory location with the value 100.
Global variable wager is declared as an integer and stored in a memory location.
Global variable throwDie is declared as an integer and stored in a memory location.
Global variable done is declared as a boolean and stored in a memory location.
Global variable die1 is declared as an intgeer and stored in a memory location with a library function that generates random numbers.
Global variable die2 is declared as an intgeer and stored in a memory location with a library function that generates random numbers.
